...
public class CheckHotels extends JFrame implements Runnable{
     ...
     public void run(){
         String [] text=new String[]{"JW Marriott","ITC Hotel","Maradin Oriental Hotel","Four Seasons Hotel","Raddison Blue Hotel","Classino Hotel","The Bay Club Hotel","Breeze Blow Hotel","The Taj Hotel","Happy Morning Motel"};
